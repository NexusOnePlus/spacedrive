        ...
        RulePerKind::new_reject_files_by_globs_str(
            [
                ...
                vec![
                    ...
                    "[A-Z]:/Users/*/ntuser.dat*",
                    "[A-Z]:/Users/*/{ntuser.ini,ntuser.dat,NTUSER.DAT}",
                    "[A-Z]:/Users/*/{Cookies,AppData,NetHood,Recent,PrintHood,SendTo,Templates,Start Menu,Application Data,Local Settings,My Documents}",
                    "[A-Z]:/{\\$Recycle.Bin,\\$WinREAgent,Documents and Settings,Program Files,Program Files (x86),ProgramData,Recovery,PerfLogs,Windows,Windows.old}",
                    "[A-Z]:/System Volume Information",
                    "[A-Z]:/{config,pagefile,hiberfil}.sys",
                    "[A-Z]:/swapfile.sys",
